...
const FAQPage = () => {
  return (
    <div>
      <PageBreadcrumb breadcrumbLink={"FAQ"} breadcrumbTitle={"frequently asked question"} />
      <div className="uren-container">
        <h1 className="text-dark-gray text-lg md:text-xl lg:text-2xl font-bold mb-4 lg:mb-6">Below are FAQs, you may find the answer for yourself.</h1>
        <p className="text-sm text-body mb-6 lg:mb-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec id erat sagittis, faucibus metus malesuada, eleifend turpis. Mauris semper augue id nisl aliquet, a porta lectus mattis. Nulla at tortor augue. In eget enim diam. Donec gravida tortor sem, ac fermentum nibh rutrum sit amet. Nulla convallis mauris vitae congue consequat. Donec interdum nunc purus, vitae vulputate arcu fringilla quis. Vivamus iaculis euismod dui.</p>
...
const accordionData = [
  ...
  {
    title: "Aenean elit orci, efficitur quis nisl at?",
    content:
      "Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.",
  },
];
