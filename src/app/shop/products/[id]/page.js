      ...
      <div className="uren-container">
        <div className="product-details-layout">
          ...
          <div className="product-details-content">
            ...
            {/* Product Rating */}
            <div className="my-4"><ProductRating rating={3.5} text={"base"} /></div>
            ...
            <div className="mt-6 flex gap-x-2 items-center uppercase">
              <h6 className="text-dark font-bold text-lg">Tags:</h6>
              {tags.map((tag, index) =>
                <Link href={"/"} key={index} className="text-[#999] text-sm hover:text-primary transition-all ease-in-out duration-500">{tag},</Link>
              )}
            </div>
          </div>
        </div>        
