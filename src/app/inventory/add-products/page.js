...
const AddProductPage = () => {
  const { carBrandList, modelsList, selectedBrand, handleSelectedBrand } = useCarBrand();
  ...
  return (
    <div className="">
      ...
      <form className="add-product-form-layout">
        ...
        {/* Old Price Field */}
        <InputField
          label={"Old Price"} name={"old-price"}
        ...
        <SelectFromDD
          ...
          myList={categories}
          required={true}
          value={pickedCategory} onChange={handlePickedCategory}
        />
        ...
        {/* Main Image */}
        <ImageField
          name={"main-img"} label={"Main Image"}
        />
        {/* Image 2 */}
        <ImageField
          name={"img2"} label={"Image 2"}
        />
        {/* Image 3 */}
        <ImageField
          name={"img3"} label={"Image 3"}
        />
        {/* Image 4 */}
        <ImageField
          name={"img4"} label={"Image 4"}
          required={false}
        />
        {/* Image 5 */}
        <ImageField 
          name={"img5"} label={"Image 5"} 
          required={false} 
        />
        {/* Image 6 */}
        <ImageField 
          name={"img6"} label={"Image 6"} 
          required={false}
        />
        {/* Image 7 */}
        <ImageField 
          name={"img7"} label={"Image 7"} 
          required={false}
        />
        {/* Image 8 */}
        <ImageField 
          name={"img8"} label={"Image 8"} 
          required={false}
        />
        {/* Image 9 */}
        <ImageField 
          name={"img9"} label={"Image 9"} 
          required={false}
        />
        {/* Image 10 */}
        <ImageField 
          name={"img10"} label={"Image 10"} 
          required={false} 
        />
        {/* Image 11 */}
        <ImageField 
          name={"img11"} label={"Image 11"} 
          required={false} 
        />
        {/* Image 12 */}
        <ImageField 
          name={"img12"} label={"Image12"} 
          required={false} 
        />
        {/* Image 13 */}
        <ImageField 
          name={"img13"} label={"Image 13"} 
          required={false} 
        />
        {/* Image 14 */}
        <ImageField 
          name={"img14"} label={"Image 14"} 
          required={false} 
        />
        {/* Image 15 */}
        <ImageField 
          name={"img15"} label={"Image 15"} 
          required={false}
        />
      </form>
    </div>
