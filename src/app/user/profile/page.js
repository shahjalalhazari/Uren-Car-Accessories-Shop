      ...
      <div className="main-content">
        ...
        {activeTab === "Orders" && (
          <div className="orders">
            ...
            <p className="body-text mt-4">Here you will get all the ordered information.</p>
              <div className="ordered-list mt-6 lg:mt-8">
                <div className="ordered-list-item">
                  <div className="item-head">
                    <p><span className="text-highlight">Order #4563</span> <br />Date: 18 Apr 2025</p>
                    <p className="item-price">AED 999.99</p>
                  </div>
                  <div className="item-body">
                    <div className="item-body-content">
                      <p>Delivery On <br /> <span className="text-highlight">21 Apr 2025</span></p>
                      <div className="badge badge-soft badge-primary rounded-none">On Hold</div>
                    </div>
        ...
        {activeTab === "Payment Methods" && (
            <div className="payment-methods">
              ...
              <div className="w-full md:w-1/2 lg:w-1/3 mx-auto mt-6 lg:mt-8">
                <button className="uren-transition profile-page-btn">Add New</button>
              </div>
            </div>
        )}
            ...
            <div className="account-details">
              ...
              <form className="account-details-form">
                ...
                <div className="w-full md:w-1/2 lg:w-1/3 mx-auto">
                  <input type="submit" value="Update Changes" className="uren-transition profile-page-btn" />
                </div>
              </form>
              <h6 className="profile-heading mb-6 lg:mb-8 mt-8">Change Password</h6>
              <form className="change-password-form">
                <PasswordField label={"Current Password"} name={"current-password"} placeholder={"Enter Current Password"}/>
                <div className="grid md:grid-cols-2 gap-x-6 lg:gap-x-8">
                  <PasswordField label={"New Password"} name={"new-password"} placeholder={"Enter New Password"}/>
                  <PasswordField label={"New Confirm Password"} name={"new-confirm-password"} placeholder={"Enter New Confirm Password"}/>
                </div>
                <div className="w-full md:w-1/2 lg:w-1/3 mx-auto">
                  <input type="submit" value="Update Password" className="uren-transition profile-page-btn" />
                </div>
              </form>
            </div>
        )}
